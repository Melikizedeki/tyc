    ...
    <header className="bg-white sticky top-0 z-50 shadow-md">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div className="hidden md:flex items-center gap-6 text-teal-700 text-lg">
          ...
          <a href="#" className="hover:text-teal-500 transition"><FontAwesomeIcon icon={faTwitter} /></a>
          <a href="#" className="hover:text-teal-500 transition"><FontAwesomeIcon icon={faInstagram} /></a>
          <button
        ...
        <nav className="md:hidden bg-white border-t animate-slideDown">
          <div className="px-6 py-4 space-y-3">
            ...
            <div>
              ...
              {mobileAboutOpen && (
                <div className="pl-4 mt-1 space-y-2 border-l-2 border-teal-300">
